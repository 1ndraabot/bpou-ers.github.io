const pricelist = ()=> {
    return(
        ...
        <div className="container mx-[90px] mt-[95px] ">
            <div className="grid grid-cols-12 gap-x-5 gap-y-9">
                <h1 className="col-span-12 text-putih text-center text-[64px] font-bold ">Choose Your <span className="text-kuning">Choice</span></h1>
